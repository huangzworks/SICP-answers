...
::
    ...
    1 ]=> (define z (make-complex-from-real-imag 3 4))
...
要让这个复数系统的 ``magnitude`` 函数以及其他通用操作正常运作，我们需要像 Alyssa 说的那样，为 ``'(complex)`` 类型关联相应的操作函数才行。
...
.. literalinclude:: code/p119-attach-tag-and-type-tag-and-contents.scm
