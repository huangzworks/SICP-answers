...
.. literalinclude:: code/31-recursive-product.scm

测试：

::

    1 ]=> (load "30-recursive-product.scm")

    ;Loading "30-recursive-product.scm"... done
    ;Value: product
...
.. literalinclude:: code/31-iterative-product.scm

测试：

::

    1 ]=> (load "30-iterative-product.scm")

    ;Loading "30-iterative-product.scm"... done
    ;Value: product
...
::
    ...
    ;  Loading "31-iterative-product.scm"... done
    ;... done
    ;Value: factorial
...
通过控制输入的参数 :math:`n` ，我们可以控制计算所得的 :math:`\pi` 值的精确度。
