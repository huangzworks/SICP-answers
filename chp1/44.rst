...
根据定义，表达式 ``(smooth-n-times f 3)`` 的展开式应该为：
...
.. literalinclude:: code/44-iterative-smooth-n-times.scm
...
::
    ...
    1 ]=> (load "44-iterative-smooth-n-times.scm")

    ;Loading "44-iterative-smooth-n-times.scm"...
    ;  Loading "44-smooth.scm"... done
    ;... done
    ;Value: smooth-n-times
