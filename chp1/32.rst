...
.. literalinclude:: code/32-recursive-accumulate.scm


重定义 sum 和 product
------------------------
通过调用 ``accumulate`` 函数，我们可以重定义 ``sum`` ：
...
::
    ...
    ;Loading "32-sum.scm"...
    ;  Loading "32-recursive-accumulate.scm"... done
    ;... done
    ;Value: sum
...
.. literalinclude:: code/32-iterative-accumulate.scm

测试：

::

    1 ]=> (load "32-iterative-accumulate.scm")

    ;Loading "32-iterative-accumulate.scm"... done
    ;Value: accumulate
