...
::
    ...
    1 ]=> (equ? (make-complex-from-real-imag 1 2)       ; 对比直角坐标
    ...
    1 ]=> (equ? (make-complex-from-mag-ang 1 2)         ; 对比幅角坐标
    ...
    1 ]=> (equ? (make-complex-from-real-imag 1 2)       ; 直角坐标和幅角坐标也是可以对比的
                (make-complex-from-mag-ang 1 2))        ; 但是因为浮点数限制以及在两种表示之间转换的误差问题
                                                        ; 实际处理起来非常复杂
    ;Value: #f
