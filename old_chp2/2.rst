...
平面上的一个线段可以使用两个点表示，而一个点又可以使用两个坐标来表示。
...
其中线段的起点 :math:`s` 在坐标 :math:`(1,3)` ，终点 :math:`e` 在坐标 :math:`(4,3)` ，中点 :math:`m` 在坐标 :math:`(2.5,3)` 。
...
.. literalinclude:: code/2-midpoint.scm
...
::
    ...
    1 ]=> (load "2-midpoint.scm")

    ;Loading "2-midpoint.scm"...
    ;  Loading "2-segment-selector.scm"... done
    ;  Loading "2-point-constructor.scm"... done
    ;  Loading "2-point-selector.scm"... done
    ;... done
